...
public class HbaseApi {
    ...
    public static void addData(String rowKey, String tableName,
        ...
        HTable table = new HTable(conf, Bytes.toBytes(tableName));// HTabel负责跟记录相关的操作如增删改查等//获取表
    ...
    public static void batchGetResult(String tableName,String[] rowKeys){
    ...
    public static void main(String[] args) throws Exception {
        ...
        //批量获取数据
        batchGetResult("blog2",new String[]{"rowkey1","rowkey2","rowkey3"});
        // 遍历查询
